...
const skillsItems = [
	{ icon: <FiLayout />, color: 'blue', label: 'Frontend \ndevelopment' },
	{ icon: <FiEdit />, color: 'purple', label: 'UI/UX' },
	{ icon: <FiCpu />, color: 'red', label: 'Operating \nSystems' },
	{ icon: <FiShield />, color: 'indigo', label: 'Penetration \nTesting' },
	{ icon: <FiLock />, color: 'orange', label: 'Cryptography' },
	{ icon: <FiTrendingUp />, color: 'green', label: 'Data \nAnalysis' },
