  ...
  return (
    <div className={`flex items-center justify-center py-24 ${wrapperClassName}`}>
      <div className="rainbow-border-wrapper">
        <button onClick={() => showMyWorks('works')} className="relative w-[160px] h-12 flex items-center justify-center px-6 bg-black rounded-xl border-none text-white cursor-pointer font-black transition-all duration-300 z-10 group overflow-hidden">
          <span className="absolute left-1/2 -translate-x-1/2 transition-all duration-300 whitespace-nowrap group-hover:translate-x-full group-hover:opacity-0 flex items-center gap-2"># MY WORKS<IoArrowForward className="text-xl" /></span>
