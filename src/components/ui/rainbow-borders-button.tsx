...
export const Button = ({ wrapperClassName = '', onShowMyWorks }: RainbowButtonProps) => {

  return (
    <div className={`flex items-center justify-center py-24 ${wrapperClassName}`}>
      <div className="rainbow-border-wrapper">
        <button onClick={() => onShowMyWorks('works')} className="relative w-[400px] h-12 flex items-center justify-center px-6 bg-black rounded-xl border-none text-white cursor-pointer font-black transition-all duration-300 z-10 group overflow-hidden">
